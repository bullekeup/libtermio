#!/bin/sh -e
# Autogen script for autotools, most taken from libcoap project
...
INSTALL
aclocal.m4 ar-lib
termio_config.h termio_config.h.in* compile config.guess config.h* config.log config.status config.sub configure
depcomp
doc/Doxyfile doc/doxyfile.stamp doc/doxygen_sqlite3.db doc/Makefile
install-sh
